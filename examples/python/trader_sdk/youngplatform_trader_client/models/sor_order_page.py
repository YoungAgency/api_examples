...
T = TypeVar("T", bound="SorOrderPage")
...
class SorOrderPage:
    """
    Attributes:
        data (list[SorOrder] | Unset): Items on this page, most recent first.
        has_more (bool | Unset): Whether more items exist beyond this page.
        next_cursor (Cursor | Unset):
    """

    data: list[SorOrder] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _data is not UNSET:
            ...
            for data_item_data in _data:
                data_item = SorOrder.from_dict(data_item_data)
        ...
        sor_order_page.additional_properties = d
        return sor_order_page
