...
if TYPE_CHECKING:
    from ..models.trader_market import TraderMarket


T = TypeVar("T", bound="TraderMarkets")
...
class TraderMarkets:
    """
    Attributes:
        markets (list[TraderMarket] | Unset): All tradable markets.
    """

    markets: list[TraderMarket] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _markets is not UNSET:
            ...
            for markets_item_data in _markets:
                markets_item = TraderMarket.from_dict(markets_item_data)
        ...
        trader_markets.additional_properties = d
